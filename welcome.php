...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <a href="user">Customers Acoount</a>
...
?>
    ...
    <td> <a href="welcome.php?edit=<?php echo $row['id'] ;?>">Edit</a></td>
    </tr>
    <?php } ?>
    </table>
...
?>
    ...
    <a href="season.php">Season Greatings</a>
    </ul>
    <a href="">Backup</a>
...
<div class="container" style="background-color: #d9e6f2 ;marging:20%;">
  ...
  <div class="color">
    ...
    background-color:gray;
     border-style: solid;
    border-width: 2px;"href="logout.php">EXIT</a>
...
<div class="row">
<div class="col-lg-12">
<img style="width: 100%; height: 400px;" src="image/index.jpg" />
