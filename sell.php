...
<p class="solid" ><a href="addnew.php" style="color: red;"><strong>Add New</strong></a></p>
...
$sql = "SELECT id,description ,category,date,price,sellingprice,inventory,Waprice FROM app";
